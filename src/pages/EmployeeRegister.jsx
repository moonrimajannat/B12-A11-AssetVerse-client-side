    ...
    return (
        <div className="flex items-center gap-16 my-20 justify-center mb-16 p-5 lg:p-0">
            <div className="rounded-2xl border-2 border-blue-400 w-full md:w-[500px]">
                <h1 className="text-4xl text-black text-center font-bold my-5">Employee Register</h1>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="card-body px-5 md:px-10 mt-8">
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <input type="email" {...register("email", { required: true })} name="email" placeholder="personal@email.com" className="border-2 px-3 py-2 w-full border-blue-300 rounded-lg my-2 focus:outline-none " />
